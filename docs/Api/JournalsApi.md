# EconomicRest\JournalsApi

All URIs are relative to https://restapi.e-conomic.com, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**getJournal()**](JournalsApi.md#getJournal) | **GET** /journals/{id} |  |
| [**searchJournals()**](JournalsApi.md#searchJournals) | **GET** /journals |  |


## `getJournal()`

```php
getJournal($id): \EconomicRest\Model\Journal
```
...
$apiInstance = new EconomicRest\Api\JournalsApi(
...
try {
    $result = $apiInstance->getJournal($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling JournalsApi->getJournal: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\EconomicRest\Model\Journal**](../Model/Journal.md)
...
```php
searchJournals($filter, $sort, $skip_pages, $page_size): \EconomicRest\Model\SearchJournalsResponse
```
...
try {
    $result = $apiInstance->searchJournals($filter, $sort, $skip_pages, $page_size);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling JournalsApi->searchJournals: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\EconomicRest\Model\SearchJournalsResponse**](../Model/SearchJournalsResponse.md)
