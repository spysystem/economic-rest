...
/**
 * SupplierInvoiceEntry Class Doc Comment
 *
 * @category Class
 ...
 */
class SupplierInvoiceEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return SupplierInvoiceEntryModelFields
      */
    public static function GetModelFields(): SupplierInvoiceEntryModelFields
    {
        return new SupplierInvoiceEntryModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return SupplierInvoiceEntryModelAttributes
      */
    public static function GetModelAttributes(): SupplierInvoiceEntryModelAttributes
    {
        return new SupplierInvoiceEntryModelAttributes();
    }
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SupplierInvoiceEntry';
    ...
    */
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 250)) {
            throw new \InvalidArgumentException('invalid length for $text when calling SupplierInvoiceEntry., must be smaller than or equal to 250.');
        }
    ...
    public function setDate($date)
    {
        ...
        if ((!preg_match("/\\d{4}-\\d{2}-\\d{2}/", ObjectSerializer::toString($date)))) {
            throw new \InvalidArgumentException("invalid value for \$date when calling SupplierInvoiceEntry., must conform to the pattern /\\d{4}-\\d{2}-\\d{2}/.");
        }
     ...
     * Sets entry_type
     *
     * @param string|null $entry_type Type of the journal entry. This is automatically set to supplierInvoice.
     *
     * @return self
     */
    ...
    public function setSupplierInvoiceNumber($supplier_invoice_number)
    {
        ...
        if ((mb_strlen($supplier_invoice_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $supplier_invoice_number when calling SupplierInvoiceEntry., must be smaller than or equal to 30.');
        }
    ...
    public function setDueDate($due_date)
    {
        ...
        if ((!preg_match("/\\d{4}-\\d{2}-\\d{2}/", ObjectSerializer::toString($due_date)))) {
            throw new \InvalidArgumentException("invalid value for \$due_date when calling SupplierInvoiceEntry., must conform to the pattern /\\d{4}-\\d{2}-\\d{2}/.");
        }
