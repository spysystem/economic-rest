...
/**
 * PaymentTypeHandlerOneOf4 Class Doc Comment
 *
 * @category Class
 * @package  EconomicRest
 * @author   OpenAPI Generator team
 ...
 */
class PaymentTypeHandlerOneOf4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return PaymentTypeHandlerOneOf4ModelFields
      */
    public static function GetModelFields(): PaymentTypeHandlerOneOf4ModelFields
    {
        return new PaymentTypeHandlerOneOf4ModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return PaymentTypeHandlerOneOf4ModelAttributes
      */
    public static function GetModelAttributes(): PaymentTypeHandlerOneOf4ModelAttributes
    {
        return new PaymentTypeHandlerOneOf4ModelAttributes();
    }
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentTypeHandler_oneOf_4';
    ...
    */
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) > 100)) {
            throw new \InvalidArgumentException('invalid length for $message when calling PaymentTypeHandlerOneOf4., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($message) < 5)) {
            throw new \InvalidArgumentException('invalid length for $message when calling PaymentTypeHandlerOneOf4., must be bigger than or equal to 5.');
        }
