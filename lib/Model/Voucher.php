...
class Voucher implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return VoucherModelFields
      */
    public static function GetModelFields(): VoucherModelFields
    {
        return new VoucherModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return VoucherModelAttributes
      */
    public static function GetModelAttributes(): VoucherModelAttributes
    {
        return new VoucherModelAttributes();
    }
    ...
    */
     ...
     * Gets entries
     *
     * @return \EconomicRest\Model\VoucherEntries|null
     */
     ...
     * Sets entries
     *
     * @param \EconomicRest\Model\VoucherEntries|null $entries entries
     *
     * @return self
     */
     ...
     * Sets attachment
     *
     * @param string|null $attachment A unique reference to the attachment file on the given voucher.
     *
     * @return self
     */
    ...
    public function setVoucherNumber($voucher_number)
    {
        ...
        if (($voucher_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $voucher_number when calling Voucher., must be bigger than or equal to 1.');
        }
     ...
     * Sets self
     *
     * @param string|null $self A unique reference to the specific voucher.
     *
     * @return self
     */
