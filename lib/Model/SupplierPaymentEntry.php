...
/**
 * SupplierPaymentEntry Class Doc Comment
 *
 * @category Class
 ...
 */
class SupplierPaymentEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return SupplierPaymentEntryModelFields
      */
    public static function GetModelFields(): SupplierPaymentEntryModelFields
    {
        return new SupplierPaymentEntryModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return SupplierPaymentEntryModelAttributes
      */
    public static function GetModelAttributes(): SupplierPaymentEntryModelAttributes
    {
        return new SupplierPaymentEntryModelAttributes();
    }
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SupplierPaymentEntry';
    ...
    */
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 250)) {
            throw new \InvalidArgumentException('invalid length for $text when calling SupplierPaymentEntry., must be smaller than or equal to 250.');
        }
    ...
    public function setDate($date)
    {
        ...
        if ((!preg_match("/\\d{4}-\\d{2}-\\d{2}/", ObjectSerializer::toString($date)))) {
            throw new \InvalidArgumentException("invalid value for \$date when calling SupplierPaymentEntry., must conform to the pattern /\\d{4}-\\d{2}-\\d{2}/.");
        }
     ...
     * Sets entry_type
     *
     * @param string|null $entry_type Type of the journal entry. This is automatically set to supplierPayment.
     *
     * @return self
     */
    ...
    public function setSupplierInvoiceNumber($supplier_invoice_number)
    {
        ...
        if ((mb_strlen($supplier_invoice_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $supplier_invoice_number when calling SupplierPaymentEntry., must be smaller than or equal to 30.');
        }
