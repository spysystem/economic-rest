...
/**
 * SupplierSalesPerson Class Doc Comment
 *
 * @category Class
 ...
 */
class SupplierSalesPerson implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return SupplierSalesPersonModelFields
      */
    public static function GetModelFields(): SupplierSalesPersonModelFields
    {
        return new SupplierSalesPersonModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return SupplierSalesPersonModelAttributes
      */
    public static function GetModelAttributes(): SupplierSalesPersonModelAttributes
    {
        return new SupplierSalesPersonModelAttributes();
    }
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Supplier_salesPerson';
    ...
    */
     ...
     *
     * @param int|null $employee_number Unique identifier of the employee.
     *
     * @return self
     */
    public function setEmployeeNumber($employee_number)
    {
        ...
        if (($employee_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $employee_number when calling SupplierSalesPerson., must be bigger than or equal to 1.');
        }
     ...
     * Sets self
     *
     * @param string|null $self A unique reference to the employee resource.
     *
     * @return self
     */
