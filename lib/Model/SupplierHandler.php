...
/**
 * SupplierHandler Class Doc Comment
 *
 * @category Class
 ...
 */
class SupplierHandler implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return SupplierHandlerModelFields
      */
    public static function GetModelFields(): SupplierHandlerModelFields
    {
        return new SupplierHandlerModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return SupplierHandlerModelAttributes
      */
    public static function GetModelAttributes(): SupplierHandlerModelAttributes
    {
        return new SupplierHandlerModelAttributes();
    }
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SupplierHandler';
    ...
    */
    ...
    public function setSupplierNumber($supplier_number)
    {
        ...
        if (($supplier_number > 999999999)) {
            throw new \InvalidArgumentException('invalid value for $supplier_number when calling SupplierHandler., must be smaller than or equal to 999999999.');
        }
        if (($supplier_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $supplier_number when calling SupplierHandler., must be bigger than or equal to 1.');
        }
