...
/**
 * PaymentTypeHandlerOneOf1 Class Doc Comment
 *
 * @category Class
 * @package  EconomicRest
 * @author   OpenAPI Generator team
 ...
 */
class PaymentTypeHandlerOneOf1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return PaymentTypeHandlerOneOf1ModelFields
      */
    public static function GetModelFields(): PaymentTypeHandlerOneOf1ModelFields
    {
        return new PaymentTypeHandlerOneOf1ModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return PaymentTypeHandlerOneOf1ModelAttributes
      */
    public static function GetModelAttributes(): PaymentTypeHandlerOneOf1ModelAttributes
    {
        return new PaymentTypeHandlerOneOf1ModelAttributes();
    }
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentTypeHandler_oneOf_1';
    ...
    */
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) > 100)) {
            throw new \InvalidArgumentException('invalid length for $message when calling PaymentTypeHandlerOneOf1., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($message) < 5)) {
            throw new \InvalidArgumentException('invalid length for $message when calling PaymentTypeHandlerOneOf1., must be bigger than or equal to 5.');
        }
