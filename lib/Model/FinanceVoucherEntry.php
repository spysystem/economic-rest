...
/**
 * FinanceVoucherEntry Class Doc Comment
 *
 * @category Class
 ...
 */
class FinanceVoucherEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return FinanceVoucherEntryModelFields
      */
    public static function GetModelFields(): FinanceVoucherEntryModelFields
    {
        return new FinanceVoucherEntryModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return FinanceVoucherEntryModelAttributes
      */
    public static function GetModelAttributes(): FinanceVoucherEntryModelAttributes
    {
        return new FinanceVoucherEntryModelAttributes();
    }
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinanceVoucherEntry';
    ...
    protected static $openAPITypes = [
        ...
        'vat_amount' => 'float',
        'vat_amount_base_currency' => 'float'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'vat_account' => false,
        'vat_amount' => false,
        'vat_amount_base_currency' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'vat_amount_base_currency' => 'vatAmountBaseCurrency'
    ];
    ...
    protected static $setters = [
        ...
        'vat_amount_base_currency' => 'setVatAmountBaseCurrency'
    ];
    ...
    protected static $getters = [
        ...
        'vat_amount_base_currency' => 'getVatAmountBaseCurrency'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('vat_amount_base_currency', $data ?? [], null);
    }
    ...
    */
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 250)) {
            throw new \InvalidArgumentException('invalid length for $text when calling FinanceVoucherEntry., must be smaller than or equal to 250.');
        }
    ...
    public function setDate($date)
    {
        ...
        if ((!preg_match("/\\d{4}-\\d{2}-\\d{2}/", ObjectSerializer::toString($date)))) {
            throw new \InvalidArgumentException("invalid value for \$date when calling FinanceVoucherEntry., must conform to the pattern /\\d{4}-\\d{2}-\\d{2}/.");
        }
     ...
     * Sets entry_type
     *
     * @param string|null $entry_type Type of the journal entry. This is automatically set to financeVoucher.
     *
     * @return self
     */
     ...
     * Sets vat_amount
     *
     * @param float|null $vat_amount The amount of VAT on the entry. Used if the entry has a VAT account.
     *
     * @return self
     */
    ...
    /**
     * Gets vat_amount_base_currency
     *
     * @return float|null
     */
    public function getVatAmountBaseCurrency()
    {
        return $this->container['vat_amount_base_currency'];
    }

    /**
     * Sets vat_amount_base_currency
     *
     * @param float|null $vat_amount_base_currency The amount of VAT on the voucher in base currency.
     *
     * @return self
     */
    public function setVatAmountBaseCurrency($vat_amount_base_currency)
    {
        if (is_null($vat_amount_base_currency)) {
            throw new \InvalidArgumentException('non-nullable vat_amount_base_currency cannot be null');
        }
        $this->container['vat_amount_base_currency'] = $vat_amount_base_currency;
