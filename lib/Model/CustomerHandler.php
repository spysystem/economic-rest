...
/**
 * CustomerHandler Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomerHandler implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return CustomerHandlerModelFields
      */
    public static function GetModelFields(): CustomerHandlerModelFields
    {
        return new CustomerHandlerModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return CustomerHandlerModelAttributes
      */
    public static function GetModelAttributes(): CustomerHandlerModelAttributes
    {
        return new CustomerHandlerModelAttributes();
    }
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerHandler';
    ...
    */
    ...
    public function setCustomerNumber($customer_number)
    {
        ...
        if (($customer_number > 999999999)) {
            throw new \InvalidArgumentException('invalid value for $customer_number when calling CustomerHandler., must be smaller than or equal to 999999999.');
        }
        if (($customer_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $customer_number when calling CustomerHandler., must be bigger than or equal to 1.');
        }
     ...
     * Sets self
     *
     * @param string|null $self A unique reference to the customer resource.
     *
     * @return self
     */
