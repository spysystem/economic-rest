...
/**
 * PaymentTypeHandlerOneOf5 Class Doc Comment
 *
 * @category Class
 * @package  EconomicRest
 * @author   OpenAPI Generator team
 ...
 */
class PaymentTypeHandlerOneOf5 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return PaymentTypeHandlerOneOf5ModelFields
      */
    public static function GetModelFields(): PaymentTypeHandlerOneOf5ModelFields
    {
        return new PaymentTypeHandlerOneOf5ModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return PaymentTypeHandlerOneOf5ModelAttributes
      */
    public static function GetModelAttributes(): PaymentTypeHandlerOneOf5ModelAttributes
    {
        return new PaymentTypeHandlerOneOf5ModelAttributes();
    }
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentTypeHandler_oneOf_5';
    ...
    */
    ...
    public function setOcrLineMessage($ocr_line_message)
    {
        ...
        if ((mb_strlen($ocr_line_message) > 157)) {
            throw new \InvalidArgumentException('invalid length for $ocr_line_message when calling PaymentTypeHandlerOneOf5., must be smaller than or equal to 157.');
        }
        if ((mb_strlen($ocr_line_message) < 16)) {
            throw new \InvalidArgumentException('invalid length for $ocr_line_message when calling PaymentTypeHandlerOneOf5., must be bigger than or equal to 16.');
        }
